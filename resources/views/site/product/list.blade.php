            ...
            <div class="container">
                <div class="col-lg-12 col-md-12">
                    <div class="pt-caption text-center mt-5">
                        <h1> نمونه محصولات</h1>
                        <p><a href="{{route('index')}}">خانه</a><span class="current-page">نمونه محصولات</span></p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @foreach($products as $product)
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 port-item design development">
                                <div class="portfolio-wrap portfolio-inner">
                                    <img src="{{asset('assets/upload/'.$product->image)}}" alt="project">
                                    <div class="label">
                                        <div class="label-text">
                                            <a href="{{route('productdetail',['id'=>$product->id])}}" class="text-title"> {{$product->title}}</a>
                                            <span class="lead-i"> {{$product->price}} تومان</span>
                                        </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <ul class="no-ul-list mb-2">
                                        <li>
                                            ...
                                            <label for="checkbox-1" class="checkbox-custom-label"><a href="portfolio.html#">با شرایط و ضوابط موافقت کنید</a></label>
                                        </li>
                                    </ul>
                                </div>
