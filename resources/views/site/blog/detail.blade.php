			...
			<div class="container">
				<div class="col-lg-12 col-md-12">
					<div class="pt-caption text-center mt-5">
						<h1>جزئیات مقاله</h1>
						<p><a href="{{route('index')}}">خانه</a><span class="current-page">جزئیات مقاله</span></p>
					</div>
				</div>
			</div>
		</div>
						...
						<article class="blog-news big-detail-wrap">
							<div class="blog-detail-wrap">
								...
								<figure class="img-holder">
									<a href="blog-detail.html"><img src="{{asset('assets/upload/'.@$article->image)}}" class="img-responsive" alt="News"></a>
						...
						<div class="sidebar">
							<div class="side-widget">
								<div class="side-widget-header">
									<h4><i class="ti-check-box"></i>آخرین مقالات</h4>
								</div>
											...
											<li>
												<a href="blog-detail.html#">
													<div class="blog-list-img">
														<img src="{{asset('assets/upload/'.$article->image)}}" class="img-responsive" alt="">
													</div>
												</a>
												<div class="blog-list-info">
													<h5><a href="{{route('blogdetail',['id'=>$article->id])}}" title="blog">{{$article->title}}</a></h5>
