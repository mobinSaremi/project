				...
				<div class="container">
					<div class="col-lg-12 col-md-12">
						<div class="pt-caption text-center mt-5">
							<h1>آخرین اخبار</h1>
							<p><a href="{{route('index')}}">خانه</a><span class="current-page">خبر</span></p>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-4 col-md-4">
							<div class="blog-grid-wrap mb-4" data-aos="fade-up" data-aos-duration="1200">
								<div class="blog-grid-thumb">
									<a href="blog-detail.html"><img src="{{asset('assets/upload/'.$news->image)}}" class="img-responsive" alt="" /></a>
									<div class="bg-cat-info">
                                    <div class="post-m-info">
											<h5 class="pm-month"> {{jdate('Y/m/d',$news->created_at->timestamp)}}</h5>
										</div>
									</div>
								</div>
								<div class="blog-grid-content">
									<h4 class="cnt-gb-title"><a href="{{route('newsdetail',['id'=>$news->id])}}">{{$news->title}}</a></h4>
									<p>{!! Illuminate\Support\Str::limit(@$news['description'], 100, $end='...')!!}</p>
								</div>
