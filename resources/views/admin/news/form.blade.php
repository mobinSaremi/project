    ...
    <div class="">
        <div class="row m-0  w-100">
            ...
            <!-- <div class="  col-6  form-group mb-3 mt-6 ">
                <label class="required" for="example-select">تاریخ </label>

                <input data-jdp type="text" class="form-control " name="published_at" autocomplete="off" placeholder="  لطفا تاریخ  مورد نظر را انتخاب کنید "  value="@if(isset($data))  {{$data->published_at ? \App\Library\Helper::persian2LatinDigit(jdate('Y/m/d', DateTime::createFromFormat('Y-m-d H:i:s', $data->published_at)->getTimestamp()))  : @old('published_at')}}       @endif" />
            </div> -->
